...
$query = mysqli_query($conn, "SELECT produk.*, users.username, kategori.kategori AS nama_kategori FROM produk
...
// // Fetch user and toko IDs outside the form
$queryGetId = mysqli_query($conn, "SELECT toko.id AS toko_id, users.id AS user_id FROM users
INNER JOIN toko ON toko.user_id = users.id
WHERE users.username = '$_SESSION[username]'");

$getId = mysqli_fetch_array($queryGetId);
        ...
        <div>
            ...
            <div class="container mt-5">
                <div class="d-flex justify-content-center">
                    <h3>List Produk <?php echo $_SESSION['username']; ?></h3>
                </div>
                <div class="table-responsive mt-5 bg-putih p-3">
                            ...
                            if ($jumlahProduk == 0) {
                                ...
                                while ($data = mysqli_fetch_assoc($query)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            <a href="edit-produk.php?p=<?php echo $data['id']; ?>" class="btn btn-info"><i
                    ...
                    if (isset($_POST['btndelete'])) {
                        ...
                        if ($querydelete) {
                            ...
                            <meta http-equiv="refresh" content="1;URL='tambah-produk.php'"/>
                            <?php
                        } else {
                ...
                <div class="d-flex justify-content-center">
                    <div class="my-5 col-12 col-md-6 shadow p-3" style="border-radius: 15px; background-color: #fff;">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <!-- Adding hidden input fields for user and toko IDs -->
                            <input type="hidden" name="userId" value="<?php echo $getId['user_id']; ?>">
                            <input type="hidden" name="tokoId" value=" <?php echo $getId['toko_id']; ?>">
                        ...
                        if (isset($_POST['simpan'])) {
                            ...
                            $tokoId = htmlspecialchars($_POST['tokoId']);
                            ...
                            if ($nama == '' || $kategori == '' || $harga == '' || $stok == '') {
                                ...
                                if ($image_size > 50000000) {
                                    ...
                                    if ($imageFileType != 'jpg' && $imageFileType != 'png' && $imageFileType != 'jpeg') {
                                        ...
                                        $queryTambah = mysqli_query($conn, "INSERT INTO produk (kategori_id, toko_id, user_id, nama, harga, foto, detail, stok) VALUES ('$kategori','$tokoId','$userId', '$nama', '$harga', '$newImgName', '$detail', '$stok')");
