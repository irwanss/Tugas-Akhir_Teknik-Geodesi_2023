...
$id = $_GET['p'];
$queryDetail = mysqli_query($conn, "SELECT a.*, b.kategori AS nama_kategori
FROM produk a
    ...
    if ($nama_file != '') {
        ...
        if ($nama == '' || $kategori == '' || $harga == '' || $stok == '') {
            ...
            if ($image_size > 5000000) {
                ...
                $queryUpdate = mysqli_query($conn, "UPDATE produk SET kategori_id='$kategori', harga='$harga', nama='$nama', stok='$stok', detail='$detail', foto='$newImgName' WHERE id='$id'");

                if ($queryUpdate) {
                    $success_message = "Produk berhasil diupdate";
                    header("refresh:1;URL='tambah-produk.php'");
                }
            }
        }
    } else {
        ...
        if ($nama == '' || $kategori == '' || $harga == '' || $stok == '') {
            ...
            $queryUpdate = mysqli_query($conn, "UPDATE produk SET kategori_id='$kategori', harga='$harga', nama='$nama', stok='$stok', detail='$detail' WHERE id='$id'");
...
<div class="tubuh">
        <div>
            <nav><?php require "navbar.php" ?></nav>
            ...
            <div class="my-5 col-12 col-lg-6 shadow p-3" style="border-radius: 15px; background-color: #fff;">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="container mt-2">
                        ...
                        <div class="row mt-3">
                            <div class="col">
                                <input type="number" name="harga" class="form-control" placeholder="Harga" value="<?= $data['harga'] ?>" autocomplete="off" required>
                            </div>
                            <div class="col">
